...
#SBATCH --job-name=sharpy_benchmark_weak
#SBATCH --output=/sdf/home/d/dnyanhet/sharpy_fresh/job_logs/benchmark_weak_%j.out
# rank count set at submit time: sbatch --nodes=N --ntasks=N run_benchmark_weak.sh
# (only SIZE in {1,2,4,8} have a _WEAK_H5 entry in sharpy_mpi_skeleton.py)
...
srun --mpi=pmix /sdf/home/d/dnyanhet/.conda/envs/sharpy/bin/python \
    sharpy_mpi_skeleton.py --benchmark-weak
