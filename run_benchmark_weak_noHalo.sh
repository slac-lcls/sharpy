...
#SBATCH --job-name=sharpy_benchmark_weak_noHalo
#SBATCH --output=/sdf/home/d/dnyanhet/sharpy_fresh/job_logs/benchmark_weak_noHalo_%j.out
# rank count set at submit time: sbatch --nodes=N --ntasks=N run_benchmark_weak_noHalo.sh
