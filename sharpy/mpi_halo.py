...
def setup_halo(local_frames, local_tx_xp, local_ty_xp, frames_norm,
    ...
    """
    One-time halo setup before the power iteration.
    ...
    Parameters
    ----------
    local_frames   : (local_nframes, nx, ny) complex64, this rank's frames
    ...
    null_state = dict(H_cross=None, halo_global=np.array([], np.int64),
